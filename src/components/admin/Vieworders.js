...
//   }
  ...
  orderStatusCount=()=> {
    ...
    Httpconfig.httptokenpost(Constant.siteurl + "api/OM/orderProcess/getAdminOrderDashboardCount",
    {
  ...
  getAllOrders(){
    ...
    Httpconfig.httptokenpost(Constant.siteurl + "api/OM/orderProcess/getAdminOrderDashboardDetails",{
        ...
        const ordersView= response.data.data.map((LoadedData,num)=>{
            ...
            let hoursDiff=moment(LoadedData.order_date, 'YYYY-MM-DD hh:mm:ss').fromNow();
            ...
            return (
              ...
              {LoadedData.order_status<5 ?
                  <div class="dropdown">
                      <p class="dropbtn">{LoadedData.order_status_tbl.status} <h6 class="td_down">{hoursDiff}</h6></p>
                      <h6 class="caret"><img src="https://static.thenounproject.com/png/427197-200.png" /></h6>
                  ...
                  <div class="row">
                      <div class="col-md-12 no_padding">
                          ...
                          <ul>
                              ...
                              <li class="stat status-1" onClick={this.handleSelectedStatus.bind(this,"1")}>Pending ({this.state.pending? this.state.pending :"0"})</li>
                              <li class="stat status-2" onClick={this.handleSelectedStatus.bind(this,"2")}>Prescription review ({this.state.reviewed? this.state.reviewed :"0"})</li>
                              <li class="stat status-3" onClick={this.handleSelectedStatus.bind(this,"3")}>Processing ({this.state.processing? this.state.processing :"0"})</li>
                              <li class="stat status-4" onClick={this.handleSelectedStatus.bind(this,"4")}>Shipped ({this.state.shipping? this.state.shipping :"0"})</li>
                              <li class="stat status-5" onClick={this.handleSelectedStatus.bind(this,"5")}>Delivered ({this.state.delivered? this.state.delivered :"0"})</li>
                              <li class="stat status-6" onClick={this.handleSelectedStatus.bind(this,"6")}>Cancelled ({this.state.cancelled? this.state.cancelled :"0"})</li>
                          </ul>
                      </div>
                  </div>
                  </div>
