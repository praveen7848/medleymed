...
export default class Retailerlogin extends Component {
   ...
   checkLogin = (event) => {
    ...
    Httpconfig.httptokenpost(Constant.siteurl + "api/Users/login", post_data)
      .then((response) => {
        ...
        reactLocalStorage.setObject("retuserObj", response.data.loginOutput.data.userobj);
        //alert(response.data.loginOutput.data.userobj.accessToken);
        reactLocalStorage.setObject("retailerToken", response.data.loginOutput.data.userobj.accessToken);
        toast.success(response.data.loginOutput.notification.message);
       // return
        setTimeout(() => this.props.history.push("./Retailerdashboard"), 2000);
        }
      })
      .catch((error) => {
        toast.error(error);
  ...
  componentDidMount=()=>{
    var DocObject = localStorage.getItem("retuserObj");
...
{/* <PatientHeader onSelectLanguage={this.handleLanguage}/> */}
  ...
  <div class="container">
    ...
    {/* <img src="../images/doctor-img/Login screens/Logo.svg" /> */}
    <img src="../images/patient/img/logo.svg" />
    ...
    <div class="doc_login_form">
        ...
        <form  onSubmit={this.checkSubmit.bind(this)}>
            ...
            <label>Password</label>
              ...
              <img class="password_view"  onClick={ this.showPassword }  src="../images/doctor-img/Login screens/view_password.svg" />
            </div>
            <span className="cRed">
