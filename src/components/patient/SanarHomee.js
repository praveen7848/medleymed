...
export default class Homee extends Component {
    ...
    .then((response) => {
      ...
      if(response.data.status=="200" && response.data.error==false){
        ...
        const upComingDetailsView= response.data.data.map((upComingDetails,num)=>{ 
          ...
          if(upcomingStatus.includes(upComingDetails.status)==true){
            ...
            if(upComingDetails.patient_tbl.profile_pic!=null) {
              ...
              if(upComingDetails.doctor_tbl.tbl_user.gender=="Male"){
            ...
            return ( 
              ...
              <h4>Your appointment scheduled on <span><img src="../images/patient/img/Ordermedicine//Date.svg" />27 January 2021 11:20 A.M
        ...
        if(upComingDetailsView==null){ 
          ...
          console.clear();
          console.log("rakesh");
          console.log(upComingDetailsView);
  ...
  render() {
    ...
    return (
      ...
      margin={8}>
      <div >
      <img src="../images/patient/img/Homepage/Banner.png" alt="" />
      </div>
      <div >
      <img src="../images/patient/img/Homepage/Banner.png" alt="" />
      </div> 
