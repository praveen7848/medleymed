...
export default class Patientheader extends Component {
   ...
   constructor(props) {
      ...
      this.state = {
         ...
         userName: "",
         selectedModule:"nav-item dropdown",
         friendOptions : [
            {
              key: 'en-us',
              text: ' English ',
        ...
        if(modulesCount>0){
           ...
           modulesList= response.data.data.map((modulesData,num)=>{ 
             ...
             if(page[1]=='ordermedicinehome' || page[1]=='selectretailer'){
              ...
              {/* onClick={this.doRedirect.bind(this,modulesData.master_sub_module_pages_tbls[0].web_reference_page_name)} */}
               ...
               <section>
                  ...
                  <header id="header" class="fixed-top">
                     <div class="container">
                        ...
                        <nav class="float-right d-none d-lg-block order_nav">
